...
#define QAPP_ORG_NAME "Flincoin"
#define QAPP_ORG_DOMAIN "flincoin.com"
#define QAPP_APP_NAME_DEFAULT "Flincoin-Qt"
#define QAPP_APP_NAME_TESTNET "Flincoin-Qt-testnet"
